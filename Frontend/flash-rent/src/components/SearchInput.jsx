export default function SearchInput ({className='',  onSubmit }) {
    return (
        <form onSubmit={onSubmit} className={"flex items-center" + className}>
            <div className="relative w-full">
                ...
                <input type="text" name="search-input" id="search-input" placeholder="Search for properties" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 
