  ...
  return (
    <ul className="w-full p-4 divide-y divide-gray-200 dark:divide-gray-700">
      {properties.map((property) => (
        <li key={property.property_id} className="py-3 sm:py-4">
          <div className="flex items-center space-x-4 rtl:space-x-reverse">
            <div className="flex-shrink-0">
              <img className="w-12 h-12 rounded-full" src={property.property_image_url} alt={`${property.property_name} image`} />
            </div>
            ...
            <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                Monthly Rent: {property.property_rentAmount}
            </div>
