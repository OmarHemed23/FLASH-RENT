...
export default function PersonalDetailsForm({ propertyName, updateFormData }) {
    ...
    return (
        <div className="grid gap-4 md:grid-cols-2 md:gap-6">
            ...
            <FormField label="First Name" type="text" name="first-name" id="first-name" placeholder="Your First Name" required onChange={handleInputChange} />
            <FormField label="Last Name" type="text" name="last-name" id="last-name" placeholder="Your Last Name" required onChange={handleInputChange} />
